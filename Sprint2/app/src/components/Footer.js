        ...
        <footer className='all'>
            <div className="left">
                <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
                    <img src="instagram.png" alt="Botón: Enlace a Instagram"/>
                </a>
                <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer">
                    <img src="x.png" alt="Botón: Enlace a X (Twitter)"/>
                </a>
                <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer">
                    <img className="yt" src="youtube.png" alt="Botón: Enlace a YouTube"/>
                </a>
            </div>
            ...
            <div className="right">
                <a href="https://www.googleplay.com" target="_blank" rel="noopener noreferrer">
                    <img className="google_play" src="google_play.png" alt="Botón: Descargar en Google Play"/>
                </a>
                <a href="https://www.appstore.com" target="_blank" rel="noopener noreferrer">
                    <img className="apple_store" src="apple_store.png" alt="Botón: Descargar en App Store"/>
                </a>
            </div>
        </footer>
    );
