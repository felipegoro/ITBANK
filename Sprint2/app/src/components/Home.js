      ...
      <main>
        <div className="container">
          ...
          <div className="shortcuts">
            <a className="shortcut" href='/transferencias'>Transferencias</a>
            <a className='shortcut' href="/Servicios">Servicios</a>
            <a className="shortcut">Inversiones</a>
            <a className="shortcut">Préstamos</a>
          </div>
