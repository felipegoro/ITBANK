...
const Seguros = () => {
  return (
    <div className="seguros-container">
      ...
      <p className='descripcion'>Conta con un respaldo digno y seguro para ustede y su familia. Conta con nosotros, conta con BANK-ITO.
      </p>
      ...
      <div className="seguro-card">
          ...
          <button className="seguro-button">Contratar</button>
        </div>
      
      <div className="seguro-card">
            <h2>Seguro de Salud</h2>
            <p>Te cubre de algun accidente muy grave en tu saludo o la de otra persona</p>
            <button className='seguro-button'>Contratar</button>
        </div>
